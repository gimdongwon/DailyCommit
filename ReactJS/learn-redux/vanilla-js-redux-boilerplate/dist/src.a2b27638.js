...
},{"symbol-observable":"node_modules/symbol-observable/es/index.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
  ...
  switch (action.type) {
    case TOGGLE_SWITCH:
      return _extends({}, state, {
        // 기존의 값을 그냥 두면서 leave the existing values behind
...
var store = (0, _redux.createStore)(reducer); // create reducer function

var render = function render() {
  var state = store.getState(); // 현재의 상태를 가져온다.

  var light = state.light,
      counter = state.counter; // 편의상 비할당 구조
...
store.subscribe(render); // create aciton
